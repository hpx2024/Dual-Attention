...
if __name__ == '__main__':
    ...
    if args.problem == 'setcover':
        ...
        instances_test = glob.glob('data/instances/setcover/test_400r_750c_0.05d/*.lp')
        ...
        instances_test = glob.glob('data/instances/ufacilities/test_35_35_5/*.lp')
    ...
    print(f"{len(instances_test)} validation instances for {test_size} samples")
